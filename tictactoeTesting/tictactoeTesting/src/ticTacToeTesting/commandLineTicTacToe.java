...
public class commandLineTicTacToe {
    ...
    public static String instructions = "The instructions are simple. \nTry your best to best to place your pieces in a row of three, either horizontally, vertically, or diagonally." +
            "\nYour opponent, the computer, will try to do the same. If you place your pieces in a row of three, you win.";
    ...
    private static String makeBorder(String target){
        ...
        border.append("=".repeat(target.length()));
        return (border+"\n"+target+"\n"+instructions + "\n" + border);
    }
